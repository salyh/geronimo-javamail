...
public class POP3StoreSSLTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        // Setup GreenMail
        greenMail = new GreenMail(ServerSetupTest.SMTPS_POP3S);       
        greenMail.start();
        ...
        props.setProperty("mail.smtps.port", String.valueOf(greenMail.getSmtps().getPort()));
        props.setProperty("mail.pop3s.port", String.valueOf(greenMail.getPop3s().getPort()));
        props.setProperty("mail.debug", "true");
        
        System.out.println("stmp.port: " + greenMail.getSmtps().getPort());
        System.out.println("pop3 port: " + greenMail.getPop3s().getPort());
    ...
    private void sendMessage(Session session, String msgFile) throws Exception {
        MimeMessage message;
        InputStream in = POP3StoreSSLTest.class.getResourceAsStream(msgFile);
        try {
